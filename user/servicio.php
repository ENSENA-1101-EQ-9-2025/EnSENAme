...
<div class="pc-container">
  <div class="pc-content">
    ...
    <div class="card">
      <div class="card-body">
        <div class="mb-3">
        <label for="usuarioDestino" class="form-label">Destino para <?php echo htmlspecialchars(isset($_SESSION['display_name']) ? $_SESSION['display_name'] : ($nombre !== '' ? $nombre : 'Usuario')); ?>:</label>
